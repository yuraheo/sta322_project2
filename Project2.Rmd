...
Leg length appears to be the most important factor for increasing flight time, with longer legs showing the largest positive estimated effect of +0.240 seconds. Longer leg width and paperclip use also contribute positively, though to a smaller degree (+0.240 seconds, +0.158 seconds respectively). However, none of these effects reach statistical significance as flight time does not vary dramattically across the tested designs. 
